...
import { stateLayer ,newDistrictLayer ,pointsLayer , visitHealthPointLayer} from '../js/Layers';
...
if (!container) {
    // Create the container element if not found
...
export function init() {
    var newLocation = fromLonLat([79.023986,20.160793]);
    var map = new Map({
        controls: defaults({
        ...
        layers: [
            ...
            bingLayer, stateLayer,newDistrictLayer,pointsLayer, plotselect
        ],
        target: 'map',
        view: new View({
            // center: [0, 0],
