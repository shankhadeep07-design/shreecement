...
import HealthChildDataCharts from "./health/HealthChildDataCharts";


const PillarDataChartList = () => {
    ...
    const detailsofHealthPillarGenderChart = async (filters = null) => {
        try {
        
            let requestData = { select_pillar: "health" };
            ...
            if (response.status === 1) {
                const groupedData = response?.data?.total_gender_health_year?.reduce((acc, item) => {
                ...
                const groupedCasteData = response?.data?.total_caste_health_year?.reduce((acc, item) => {
                    if (!acc[item.tfy_year]) {
                ...
                const groupedVulnerabilityData = response?.data?.total_vulnerability_health_year.reduce((acc, item) => {
                    if (!acc[item.tfy_year]) {
                ...
                const groupedSocioEconomicData = response?.data?.total_socio_economic_health_year?.reduce((acc, item) => {
                    if (!acc[item.tfy_year]) {
    ...
    useEffect(() => {
        detailsofHealthPillarGenderChart();
    }, []);
    ...
    const searchFiter = () => {
        ...
        setTimeout(() => {
            detailsofHealthPillarGenderChart(data);
        }, 100);
    };
            ...
            <div className="home-content">
                <div className="card pb-3">
                    ...
                    <div className="card-body at-elevation-z6 table-box">
                        <div class="collapse" id="collapseExample">
                         ...
                         <div className="row dash-chart-section">
                            ...
                            <div className="col-lg-6 mb-3">
                                <div className="card m-0">
                                    <div className="card-header">
                                        <h5 class="mb-0 float-left">Community</h5>
                                    </div>
                                    <div className="card-body">
                        ...
                        {/* Child part start */}
                        <div className="row dash-chart-section">
                            <HealthChildDataCharts formData={formData}/>
                        </div>
                    </div>
...
export default PillarDataChartList;