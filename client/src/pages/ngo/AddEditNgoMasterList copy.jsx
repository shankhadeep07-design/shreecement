                    ...
                    if (Array.isArray(dataToValidate[key])) {
                        dataToValidate[key].forEach((file) => {
                            if (file?.originFileObj) {
                                payload.append('tngo_audit_report_org_with_income_tax_return_doc', file.originFileObj);
                            }
                        });
                    }
                }
    ...
    useEffect(() => {
        if (data && data.tngo_id) {
            ...
            setFormData({
                ...
                tngo_list_of_exist_gov_body_members: data.tngo_list_of_exist_gov_body_members || "",
                tngo_details_of_office_bearers: data.tngo_details_of_office_bearers || "",
                tngo_audit_report_org_with_income_tax_return: data.tngo_audit_report_org_with_income_tax_return || "",
                ...
                tngo_complete_address_reg_doc_org: data.tngo_complete_address_reg_doc_org || "",
                ...
                tngo_key_person_office_address: data.tngo_key_person_office_address || "",
            });
    ...
    return (
        ...
        >
            <Form layout="vertical">
                ...
                <Row gutter={[12, 2]}>
                    <Col span={12}>
                        <Form.Item label="CSR 1 registration document of the organization" required>
                            <Input
                                value={formData.tngo_csr_one_res_org}
                                onChange={(e) => handleChange("tngo_csr_one_res_org", e.target.value)}
                            />
                            {errors.tngo_csr_one_res_org && <div className="text-danger">{errors.tngo_csr_one_res_org}</div>}
                        </Form.Item>
                    </Col>
                ...
                <Row gutter={[12, 2]}>
                    <Col span={12}>
                        <Form.Item label="Registration certificate of the organization" required>
                            <Input
                                value={formData.tngo_res_certificate_org}
                                onChange={(e) => handleChange("tngo_res_certificate_org", e.target.value)}
                            />
                            {errors.tngo_res_certificate_org && <div className="text-danger">{errors.tngo_res_certificate_org}</div>}
                        </Form.Item>
                    </Col>
                    ...
                    <Col span={12}>
                        <Form.Item
                            ...
                            required
                            validateStatus={errors?.tngo_res_certificate_org_doc ? "error" : ""}
                    ...
                    <Col span={12}>
                        <Form.Item label="PAN card of the organization" required>
                            <Input
                                ...
                                onChange={(e) => handleChange("tngo_pan_card_org", e.target.value)}
                            />
                            {errors.tngo_pan_card_org && <div className="text-danger">{errors.tngo_pan_card_org}</div>}
                        </Form.Item>
                    </Col>
                ...
                <Row gutter={[12, 2]}>
                    <Col span={12}>
                        <Form.Item label="12AA certificate (renewed)" required>
                            <Input
                                ...
                                onChange={(e) => handleChange("tngo_twelve_aa_certificate", e.target.value)}
                            />
                            {errors.tngo_twelve_aa_certificate && <div className="text-danger">{errors.tngo_twelve_aa_certificate}</div>}
                        </Form.Item>
                    </Col>
                    ...
                    <Col span={12}>
                        <Form.Item
                            ...
                            required
                            validateStatus={errors?.tngo_twelve_aa_certificate_doc ? "error" : ""}
                        ...
                        >
                            <Upload
                                ...
                                onChange={({ fileList }) => {
                                    ...
                                    handleChange("tngo_twelve_aa_certificate_doc", latestFile?.[0]);
                                }}
                                showUploadList={{
                                    showRemoveIcon: true, // ✅ allow removal directly
                                }}
                ...
                <Row gutter={[12, 2]}>
                    <Col span={12}>
                        <Form.Item label="80G certificate of the organization (renewed)" required>
                            <Input
                                value={formData.tngo_eighty_g_certificate_org}
                                onChange={(e) => handleChange("tngo_eighty_g_certificate_org", e.target.value)}
                            />
                            {errors.tngo_eighty_g_certificate_org && <div className="text-danger">{errors.tngo_eighty_g_certificate_org}</div>}
                        </Form.Item>
                    </Col>
                    ...
                    <Col span={12}>
                        <Form.Item
                            ...
                            required
                            validateStatus={errors?.tngo_eighty_g_certificate_org_doc ? "error" : ""}
                            help={errors?.tngo_eighty_g_certificate_org_doc}
                        >
                            <Upload
                                fileList={fileLists?.["tngo_eighty_g_certificate_org_doc"] || []}
                                beforeUpload={() => false}
                                multiple={false} // ✅ Single file upload only
                                accept=".pdf,.doc,.docx,.xls,.xlsx" // ✅ Restrict to PDF, Word, Excel
                                onChange={({ fileList }) => {
                                    ...
                                    handleChange("tngo_eighty_g_certificate_org_doc", latestFile?.[0]);
                                }}
                                showUploadList={{
                                    showRemoveIcon: true, // ✅ allow removal directly
                                }}
                ...
                <Row gutter={[12, 2]}>
                    ...
                    <Col span={12}>
                        <Form.Item
                            ...
                            required
                            validateStatus={errors?.tngo_memorandum_association_org_doc ? "error" : ""}
                            help={errors?.tngo_memorandum_association_org_doc}
                        >
                            <Upload
                                fileList={fileLists?.["tngo_memorandum_association_org_doc"] || []}
                                beforeUpload={() => false}
                                multiple={false} // ✅ Single file upload only
                                accept=".pdf,.doc,.docx,.xls,.xlsx" // ✅ Restrict to PDF, Word, Excel
                                onChange={({ fileList }) => {
                                    ...
                                    handleChange("tngo_memorandum_association_org_doc", latestFile?.[0]);
                                }}
                                showUploadList={{
                                    showRemoveIcon: true, // ✅ allow removal directly
                                }}
                ...
                <Row gutter={[12, 2]}>
                    <Col span={12}>
                        <Form.Item label="List of existing Governing Body Members / trusteers with PAN card details" required>
                            <Input
                                value={formData.tngo_list_of_exist_gov_body_members}
                                onChange={(e) => handleChange("tngo_list_of_exist_gov_body_members", e.target.value)}
                            />
                            {errors.tngo_list_of_exist_gov_body_members && <div className="text-danger">{errors.tngo_list_of_exist_gov_body_members}</div>}
                        </Form.Item>
                    </Col>
                    ...
                    <Col span={12}>
                        <Form.Item
                            label={
                                <span>
                                    Upload List of existing Governing Body Members / trusteers with PAN card details
                                    <Tooltip title="Supported formats: PDF, DOC, DOCX, XLS, XLSX.">
                                        <InfoCircleOutlined
                                            style={{
                                                color: "#1890ff",
                            ...
                            required
                            validateStatus={errors?.tngo_list_of_exist_gov_body_members_doc ? "error" : ""}
                            help={errors?.tngo_list_of_exist_gov_body_members_doc}
                        >
                            <Upload
                                fileList={fileLists?.["tngo_list_of_exist_gov_body_members_doc"] || []}
                                beforeUpload={() => false}
                                multiple={false} // ✅ Single file upload only
                                accept=".pdf,.doc,.docx,.xls,.xlsx" // ✅ Restrict to PDF, Word, Excel
                                onChange={({ fileList }) => {
                                    ...
                                    handleChange("tngo_list_of_exist_gov_body_members_doc", latestFile?.[0]);
                                }}
                                showUploadList={{
                                    showRemoveIcon: true, // ✅ allow removal directly
                                }}
                ...
                <Row gutter={[12, 2]}>
                    <Col span={12}>
                        <Form.Item label="Details of office bearers / responsible person of the organization" required>
                            <Input
                                value={formData.tngo_details_of_office_bearers}
                                onChange={(e) => handleChange("tngo_details_of_office_bearers", e.target.value)}
                            />
                            {errors.tngo_details_of_office_bearers && <div className="text-danger">{errors.tngo_details_of_office_bearers}</div>}
                        </Form.Item>
                    </Col>
                ...
                <Row gutter={[12, 2]}>
                    <Col span={12}>
                        <Form.Item label="Audit Report of the organization with income tax returns for three immediate financial years" required>
                            <Input
                                value={formData.tngo_audit_report_org_with_income_tax_return}
                                onChange={(e) => handleChange("tngo_audit_report_org_with_income_tax_return", e.target.value)}
                            />
                            {errors.tngo_audit_report_org_with_income_tax_return && <div className="text-danger">{errors.tngo_audit_report_org_with_income_tax_return}</div>}
                        </Form.Item>
                    </Col>

                    <Col span={12}>
                        <label htmlFor="tngo_audit_report_org_with_income_tax_return_doc" className="form-label">
                            Upload Audit Report of the organization with income tax returns for three immediate financial years
                        ...
                        >
                            <Upload
                                fileList={fileLists?.["tngo_audit_report_org_with_income_tax_return_doc"] || []}
                                multiple
                                beforeUpload={() => false}
                                accept=".pdf,.doc,.docx,.xls,.xlsx" // ✅ Restrict to PDF, Word, Excel
                                onChange={({ fileList }) => {
                                            ...
                                            <Popconfirm
                                                ...
                                                onConfirm={async () => {
                                                    ...
                                                    if (isDeleted) {
                                                        ...
                                                        setFileLists((prev) => ({
                                                            ...prev,
                                                            tngo_audit_report_org_with_income_tax_return_doc: updatedList,
                                                        }));
                                                        handleChange(
                                                            "tngo_audit_report_org_with_income_tax_return_doc",
                                                            latestFile?.[0]
                ...
                {/* Bank Details */}
                <fieldset style={{ border: "1px solid #d9d9d9", padding: "16px", borderRadius: "6px" }}>
                    <legend style={{ fontWeight: "bold", padding: "0 10px" }}>Bank Details</legend>
                    <Row gutter={[12, 2]}>
                        <Col span={12}>
                            <Form.Item label="Account number" required>
                                ...
                                />
                                {errors.tngo_bank_account_no && <div className="text-danger">{errors.tngo_bank_account_no}</div>}
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item label="Account name" required>
                                ...
                                />
                                {errors.tngo_bank_account_name && <div className="text-danger">{errors.tngo_bank_account_name}</div>}
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item label="Bank Name" required>
                                ...
                                />
                                {errors.tngo_bank_name && <div className="text-danger">{errors.tngo_bank_name}</div>}
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item label="IFSC Code" required>
                                ...
                                />
                                {errors.tngo_bank_ifsc_code && <div className="text-danger">{errors.tngo_bank_ifsc_code}</div>}
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item label="Address of the bank" required>
                                <Input.TextArea
                                    ...
                                    onChange={(e) =>
                                        handleChange("tngo_bank_address_of_the_bank", e.target.value)
                                    }
                                />
                                {errors.tngo_bank_address_of_the_bank && (
                                    <div className="text-danger">{errors.tngo_bank_address_of_the_bank}</div>
                                )}
                            </Form.Item>
                        </Col>
                        ...
                        <Col span={12}>
                            <Form.Item
                                ...
                                required
                                validateStatus={errors?.tngo_cancelled_cheque_doc ? "error" : ""}
                ...
                <Row gutter={[12, 2]}>
                    <Col span={12}>
                        <Form.Item label="FCRA registration certificate" required>
                            <Input
                                ...
                                onChange={(e) => handleChange("tngo_fcra_reg_certificate", e.target.value)}
                            />
                            {errors.tngo_fcra_reg_certificate && <div className="text-danger">{errors.tngo_fcra_reg_certificate}</div>}
                        </Form.Item>
                    </Col>
                    ...
                    <Col span={12}>
                        <Form.Item
                            ...
                            required
                            validateStatus={errors?.tngo_fcra_reg_certificate_doc ? "error" : ""}
                        ...
                        >
                            <Upload
                                ...
                                onChange={({ fileList }) => {
                                    ...
                                    handleChange("tngo_fcra_reg_certificate_doc", latestFile?.[0]);
                                }}
                                showUploadList={{
                                    showRemoveIcon: true, // ✅ allow removal directly
                                }}
                ...
                <Row gutter={[12, 2]}>
                    <Col span={12}>
                        <Form.Item label="NITI Aayog DARPAN portal registration" required>
                            <Input
                                ...
                                onChange={(e) => handleChange("tngo_niti_aayog_darpan_reg", e.target.value)}
                            />
                            {errors.tngo_niti_aayog_darpan_reg && <div className="text-danger">{errors.tngo_niti_aayog_darpan_reg}</div>}
                        </Form.Item>
                    </Col>
                    ...
                    <Col span={12}>
                        <Form.Item
                            ...
                            required
                            validateStatus={errors?.tngo_niti_aayog_darpan_reg_doc ? "error" : ""}
                        ...
                        >
                            <Upload
                                ...
                                onChange={({ fileList }) => {
                                    ...
                                    handleChange("tngo_niti_aayog_darpan_reg_doc", latestFile?.[0]);
                                }}
                                showUploadList={{
                                    showRemoveIcon: true, // ✅ allow removal directly
                                }}
                ...
                <Row gutter={[12, 2]}>
                    <Col span={12}>
                        <Form.Item label="Complete address as per registration document of the organization / in case of any change in the address please provide the valid address with documentary proof." required>
                            <Input
                                value={formData.tngo_complete_address_reg_doc_org}
                                onChange={(e) => handleChange("tngo_complete_address_reg_doc_org", e.target.value)}
                            />
                            {errors.tngo_complete_address_reg_doc_org && <div className="text-danger">{errors.tngo_complete_address_reg_doc_org}</div>}
                        </Form.Item>
                    </Col>
                    ...
                    <Col span={12}>
                        <Form.Item
                            label={
                                <span>
                                    Upload Complete address as per registration document of the organization / in case of any change in the address please provide the valid address with documentary proof.
                                    <Tooltip title="Supported formats: PDF, DOC, DOCX, XLS, XLSX.">
                                        <InfoCircleOutlined
                                            style={{
                                                color: "#1890ff",
                            ...
                            required
                            validateStatus={errors?.tngo_complete_address_reg_doc_org_doc ? "error" : ""}
                            help={errors?.tngo_complete_address_reg_doc_org_doc}
                        >
                            <Upload
                                fileList={fileLists?.["tngo_complete_address_reg_doc_org_doc"] || []}
                                beforeUpload={() => false}
                                multiple={false} // ✅ Single file upload only
                                accept=".pdf,.doc,.docx,.xls,.xlsx" // ✅ Restrict to PDF, Word, Excel
                                onChange={({ fileList }) => {
                                    ...
                                    handleChange("tngo_complete_address_reg_doc_org_doc", latestFile?.[0]);
                                }}
                                showUploadList={{
                                    showRemoveIcon: true, // ✅ allow removal directly
                                }}
                ...
                {/* Point of contact details */}
                <fieldset style={{ border: "1px solid #d9d9d9", padding: "16px", borderRadius: "6px" }}>
                    <legend style={{ fontWeight: "bold", padding: "0 10px" }}>Point of contact details</legend>
                    <Row gutter={[12, 2]}>
                        <Col span={12}>
                            <Form.Item label="Name" required>
                                <Input
                                    value={formData.tngo_contact_name}
                                    onChange={(e) => handleChange("tngo_contact_name", e.target.value)}
                                />
                                {errors.tngo_contact_name && <div className="text-danger">{errors.tngo_contact_name}</div>}
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item label="Phone Number" required>
                                <Input
                                    ...
                                    onChange={(e) => handleChange("tngo_contact_phone_no", e.target.value)}
                                />
                                {errors.tngo_contact_phone_no && <div className="text-danger">{errors.tngo_contact_phone_no}</div>}
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item label="E-mail" required>
                                <Input
                                    ...
                                    onChange={(e) => handleChange("tngo_contact_email", e.target.value)}
                                />
                                {errors.tngo_contact_email && <div className="text-danger">{errors.tngo_contact_email}</div>}
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item label="Office Address" required>
                                <Input
                                    ...
                                    onChange={(e) => handleChange("tngo_contact_office_address", e.target.value)}
                                />
                                {errors.tngo_contact_office_address && <div className="text-danger">{errors.tngo_contact_office_address}</div>}
                            </Form.Item>
                        </Col>
                ...
                {/* Key person details */}
                <fieldset style={{ border: "1px solid #d9d9d9", padding: "16px", borderRadius: "6px" }}>
                    <legend style={{ fontWeight: "bold", padding: "0 10px" }}>Key person details</legend>
                    <Row gutter={[12, 2]}>
                        <Col span={12}>
                            <Form.Item label="Name" required>
                                <Input
                                    value={formData.tngo_key_person_name}
                                    onChange={(e) => handleChange("tngo_key_person_name", e.target.value)}
                                />
                                {errors.tngo_key_person_name && <div className="text-danger">{errors.tngo_key_person_name}</div>}
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item label="Phone Number" required>
                                <Input
                                    ...
                                    onChange={(e) => handleChange("tngo_key_person_phone_no", e.target.value)}
                                />
                                {errors.tngo_key_person_phone_no && <div className="text-danger">{errors.tngo_key_person_phone_no}</div>}
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item label="E-mail" required>
                                <Input
                                    ...
                                    onChange={(e) => handleChange("tngo_key_person_email", e.target.value)}
                                />
                                {errors.tngo_key_person_email && <div className="text-danger">{errors.tngo_key_person_email}</div>}
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item label="Office Address" required>
                                <Input
                                    ...
                                    onChange={(e) => handleChange("tngo_key_person_office_address", e.target.value)}
                                />
                                {errors.tngo_key_person_office_address && <div className="text-danger">{errors.tngo_key_person_office_address}</div>}
                            </Form.Item>
                        </Col>
