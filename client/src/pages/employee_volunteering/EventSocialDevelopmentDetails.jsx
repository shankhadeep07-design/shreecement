...
import EventSocialDevelopmentApproval from './EventSocialDevelopmentApproval';
import AddEditEventNotCsrList from './events_not_csr/AddEditEventNotCsrList';
const { Title, Text } = Typography;
const { TextArea } = Input;

export default function EventSocialDevelopmentDetails() {
      ...
      {pendingFromUser?.length > 0 && (
        ...
        {eventDetails ? (
          <>
                  ...
                  <div className="d-flex align-items-center profile-pic-details">
                    ...
                    <div className="profile-title">
                      ...
                      <div className="d-flex mt-0">
                        <div className="stats">
                          {/* <b> {eventDetails.tevent_activity_title || '-'}</b> */}
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <Card title="Event CSR Details" className="custom-event-details"   extra={
             eventDetails?.tevent_approval_order == 1 && (
                <Tooltip title="Edit">
                  <Button
                    type="text"
                    icon={<EditOutlined />}
              ...
              <Descriptions column={3} size="middle" labelStyle={{ fontWeight: 500 }}>
                ...
                <Descriptions.Item
                  label={<Label icon={<EnvironmentOutlined />} text="Location / Venue" />}
                >
                ...
                >
                  <Tag color="purple">{eventDetails.tevent_start_date || "-"} {eventDetails.tevent_start_time || "-"}</Tag>
                </Descriptions.Item>

                <Descriptions.Item
                  label={<Label icon={<CalendarOutlined />} text="End Date" />}
                >
                  <Tag color="purple">{eventDetails.tevent_end_date || "-"} {eventDetails.tevent_end_time || "-"}</Tag>
                </Descriptions.Item>
             ...
             {/* <Card className="mt-5">
            ...
            
                        {
                          eventDetails?.tevent_created_by === userDetail?.id && eventDetails?.tevent_status != "submitted" && (
                            <>
                              ...
                              <Card className="mt-5">
                                <div className="d-flex justify-content-between align-items-center">
                                  <h4 orientation="left" >Event Form Submitted Lists</h4>
                        ...
                        {/* Approval Part */}
                        <EventSocialDevelopmentApproval eventDetails={eventDetails} event_id={event_id} fetchEventDetailsFunApi={fetchEventDetailsFunApi}  handleFetchPendingUser={handleFetchPendingUser}/>
                      ...
                      {isOpenUpsertModal && (
                        <AddEditEventNotCsrList
                          ...
                          data={editEvent}
                          fetchData={fetchEventDetailsFunApi}
                        />
                      )}
