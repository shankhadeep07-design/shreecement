...
import { AddEditDistrict } from './AddEditDistrict.jsx';
import { toast } from 'react-toastify';
import { getExcelExportDistrictList } from '../../../Services/District-service.js';
...
export const DistrictMaster = () => {
    ...
    let datatable_url = `${import.meta.env.VITE_API_URL}/admin/masters/districts/datatable`;
    ...
    const initiatedDistrictDatatable = () => {
        ...
        var my_url = `${import.meta.env.VITE_API_URL}/admin/masters/districts/datatable`;

        if ($.fn.DataTable.isDataTable("#initiated-District-datatable")) {
            $("#initiated-District-datatable").DataTable().destroy();
        }
        $("#initiated-District-datatable").DataTable({
            order: [[1, "asc"]],
            ...
            columns: [
                ...
                <div class="form-check form-switch d-inline-block"
                    ...
                    <input class="form-check-input toggle-switch"
                           type="checkbox"
                           id="toggleSwitch_${row.tdl_district_id}"
                           data-id="${row.tdl_district_id}"
    ...
    const getAllExportData = () => {
        getExcelExportDistrictList().then((response) => {
    ...
    useEffect(() => {
        if (exportsLists.length > 0) {
            tableToExcel("new-table", "District List"); // Trigger export once data is set
        }
    }, [exportsLists]);
            ...
            <div className="home-content">
                <div className="card pb-3">
                    ...
                    <div className="card-body at-elevation-z6 table-box" style={{ maxHeight: "calc(100vh - 23vh);", overflowX: 'auto' }}>
                        ...
                        <div className="initiated-District-table-container">
                            <div className="mt-2 table table-bordered">
                                <div>
                                    {(permissions.indexOf('list') > -1) ?
                                        <table id="initiated-District-datatable" className="table table-bordered dataTable">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>State Name</th>
                ...
                <div className="allModals">
                    ...
                    >
                        <Modal.Header closeButton>
                            <Modal.Title>{editDistrict == '' ? 'Add District' : 'Update District'}</Modal.Title>
                        </Modal.Header>
