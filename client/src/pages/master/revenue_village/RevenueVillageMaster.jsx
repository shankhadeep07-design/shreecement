...
import { getExcelExportRevenueVillageList, statusChange } from '../../../Services/Master-service.js';
import { AddEditRevenueVillage } from './AddEditRevenueVillage.jsx';

export const RevenueVillageMaster = () => {
    const [showModal, setShowModal] = useState(false);
    let [editRevenueVillage, setEditBlock] = useState("#ffffff");

    let datatable_url = `${import.meta.env.VITE_API_URL}/admin/masters/revenue/datatable`;
    ...
    const initiatedRevenueVillageDatatable = () => {
        ...
        var my_url = `${import.meta.env.VITE_API_URL}/admin/masters/revenue/datatable`;
        ...
        $("#initiated-Revenue-datatable").DataTable({
            ...
            columns: [
                ...
                {
                    name: "trevvlg_is_active",
                    data: "trevvlg_is_active",
                    searchable: false,
                    orderable: false,
                ...
                <i class="fas fa-edit text-primary edit-icon"
                   ...
                   title="Edit"
                   data-id="${row.trevvlg_revenue_village_id}">
                </i>
                ...
                <div class="form-check form-switch d-inline-block"
                    ...
                    <input class="form-check-input toggle-switch"
                           type="checkbox"
                           id="toggleSwitch_${row.trevvlg_revenue_village_id}"
                           data-id="${row.trevvlg_revenue_village_id}"
    ...
    const getAllExportData = () => {
        getExcelExportRevenueVillageList().then((response) => {
    ...
    useEffect(() => {
        if (exportsLists.length > 0) {
            tableToExcel("new-table", "Revenue Village List"); // Trigger export once data is set
        }
    }, [exportsLists]);
                        ...
                        <div className="float-right">
                            {
                                ...
                                <button
                                    ...
                                    onClick={() => addFun()}
                                >
                                    <i className="fa-solid fa-plus"></i> Add Revenue Village
                ...
                <div className="allModals">
                    ...
                    >
                        <Modal.Header closeButton>
                            <Modal.Title>{editRevenueVillage == '' ? 'Add Revenue Village' : 'Update Revenue Village'}</Modal.Title>
                        </Modal.Header>

                        <Modal.Body>
                            <AddEditRevenueVillage
                                changeModalStatus={changeModalStatus}
                                editRevenueVillage={editRevenueVillage}
                                initiatedRevenueVillageDatatable={initiatedRevenueVillageDatatable}
