...
import { fetchBlocksByDistrictIdsWithOutLabelValue } from "../../../Services/Master-service";
...
const Schema = Yup.object({
    ...
    trevvlg_revenue_village_name: trimmedString()
        ...
        .max(255, "Revenue village must be at most 255 characters")
...
export const AddEditRevenueVillage = ({
    changeModalStatus,
    editRevenueVillage,
    ...
    const inputChange = async (e) => {
        ...
        if (name === "trevvlg_revenue_village_name") {
        ...
        if (name === "trevvlg_district_id") {
            ...
            fetchBlocksByDistrictIdsWithOutLabelValue(newValue)
                .then((res) => {
    ...
    useEffect(() => {
        if (editRevenueVillage) {
            ...
            setFormData({
                ...
                trevvlg_revenue_village_name: editRevenueVillage?.trevvlg_revenue_village_name,
            ...
            fetchDistrictsByStateIds(stateId)
                .then((res) => {
                    ...
                    // load blocks
                    fetchBlocksByDistrictIdsWithOutLabelValue(districtId)
                        .then((blockRes) => {
