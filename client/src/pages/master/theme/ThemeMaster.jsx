...
export const ThemeMaster = () => {
    ...
    let datatable_url = `${import.meta.env.VITE_API_URL}/admin/masters/theme/datatable`;
    ...
    const initiatedStateDatatable = () => {
        ...
        var my_url = `${import.meta.env.VITE_API_URL}/admin/masters/theme/datatable`;
            ...
            columns: [
                ...
                <div class="form-check form-switch d-inline-block">
                    <input class="form-check-input toggle-switch"
                           type="checkbox"
                           id="toggleSwitch_${row.tthm_theme_id}"
                           data-id="${row.tthm_theme_id}"
                           ${isChecked}
                           data-table="t_theme_master">
                </div>
            `;
                    }
                },
    ...
    const getAllExportData = () => {
        getExcelExportThemeList().then((response) => {
    ...
    useEffect(() => {
        if (exportsLists.length > 0) {
            tableToExcel("new-table", "Theme List"); // Trigger export once data is set
        }
    }, [exportsLists]);
                ...
                <div className="allModals">
                    ...
                    >
                        <Modal.Header closeButton>
                            <Modal.Title>{editState == '' ? 'Add Theme' : 'Update Theme'}</Modal.Title>
                        </Modal.Header>
