...
export const StateMaster = () => {
            ...
            columns: [
                ...
                <div class="form-check form-switch d-inline-block"
                    ...
                    <input class="form-check-input toggle-switch"
                           type="checkbox"
                           id="toggleSwitch_${row.tsl_state_id}"
                           data-id="${row.tsl_state_id}"
                          
                           ${isChecked}  data-table="t_state"   >
                </div>
            `;
                    }
                },
    ...
    useEffect(() => {
        if (exportsLists.length > 0) {
            tableToExcel("new-table", "State List"); // Trigger export once data is set
        }
    }, [exportsLists]);
