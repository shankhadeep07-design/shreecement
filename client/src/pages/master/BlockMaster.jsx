...
import { AddEditBlock } from "../master/AddEditBlock.jsx";
...
export const BlockMaster = () => {
    ...
    let [editBlock, setEditBlock] = useState("#ffffff");

    let datatable_url = `${import.meta.env.VITE_API_URL}/admin/masters/blocks/datatable`;
    ...
    const initiatedBlockDatatable = () => {
        var i = 1;
        var authToken = getAuthToken();
        var my_url = `${import.meta.env.VITE_API_URL}/admin/masters/blocks/datatable`;
        if ($.fn.DataTable.isDataTable("#initiated-Block-datatable")) {
            $("#initiated-Block-datatable").DataTable().destroy();
        }
        $("#initiated-Block-datatable").DataTable({
            order: [[1, "asc"]],
            ...
            columns: [
                ...
                <div class="form-check form-switch d-inline-block"
                    ...
                    <input class="form-check-input toggle-switch"
                           type="checkbox"
                           id="toggleSwitch_${row.tbl_block_id}"
                           data-id="${row.tbl_block_id}"
    ...
    const getAllExportData = () => {
        getExcelExportBlockList().then((response) => {
    ...
    useEffect(() => {
        if (exportsLists.length > 0) {
            tableToExcel("new-table", "Block"); // Trigger export once data is set
        }
    }, [exportsLists]);
            ...
            <div className="home-content">
                <div className="card pb-3">
                    ...
                    <div className="card-body at-elevation-z6 table-box" style={{ maxHeight: "calc(100vh - 23vh);", overflowX: 'auto' }}>
                        ...
                        <div className="initiated-Block-table-container">
                            <div className="mt-2 table table-bordered">
                                <div>
                                    {(permissions.indexOf('list') > -1) ?
                                        <table id="initiated-Block-datatable" className="table table-bordered dataTable">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>State Name</th>
                ...
                <div className="allModals">
                    ...
                    >
                        <Modal.Header closeButton>
                            <Modal.Title>{editBlock == '' ? 'Add Block' : 'Update Block'}</Modal.Title>
                        </Modal.Header>
                        ...
                        <Modal.Body>
                            <AddEditBlock
                                ...
                                editBlock={editBlock}
                                initiatedBlockDatatable={initiatedBlockDatatable}
