...
import { AddEditVillageHamlet } from "../village_hamlet/AddEditVillageHamlet";


export const VillageHamletMaster = () => {
    const [showModal, setShowModal] = useState(false);
    let [editVillage, setEditVillage] = useState("#ffffff");

    let datatable_url = `${import.meta.env.VITE_API_URL}/admin/masters/villages/datatable`;
    ...
    const initiatedRevenueVillageDatatable = () => {
        ...
        var my_url = `${import.meta.env.VITE_API_URL}/admin/masters/villages/datatable`;
            ...
            columns: [
                ...
                <div class="form-check form-switch d-inline-block"
                    ...
                    <input class="form-check-input toggle-switch"
                           type="checkbox"
                           id="toggleSwitch_${row.tvl_village_id}"
                           data-id="${row.tvl_village_id}"
                           ${isChecked}
                           data-table="t_villages">
                </div>
            `;
                    }
                },
