...
import { AddEditFactory } from './AddEditFactory.jsx';
import { statusChange } from '../../Services/Master-service.js';

const FactoryMasterList = () => {

    const [showModal, setShowModal] = useState(false);
    let [editFactory, setEditFactory] = useState("#ffffff");
    let datatable_url = `${import.meta.env.VITE_API_URL}/admin/masters-management/factory-master-list/datatable`;
    const [permissions, setPermissions] = useState([])
    const [exportsLists, setExportsLists] = useState([]);
    useEffect(() => {
        getMyModulePermissionFun('factory_list')
            .then((module) => {
    ...
    const initiatedFactoryDatatable = () => {
        var i = 1;
        var authToken = getAuthToken();
        var my_url = `${import.meta.env.VITE_API_URL}/admin/masters-management/factory-master-list/datatable`;

        if ($.fn.DataTable.isDataTable("#initiated-Factory-datatable")) {
            $("#initiated-Factory-datatable").DataTable().destroy();
        }
        $("#initiated-Factory-datatable").DataTable({
            order: [[1, "asc"]],
            ...
            columns: [
                ...
                {
                    name: "tfact_is_active",
                    data: "tfact_is_active",
                    searchable: false,
                    orderable: false,
                ...
                <div class="form-check form-switch d-inline-block"
                    ...
                    <input class="form-check-input toggle-switch"
                           type="checkbox"
                           id="toggleSwitch_${row.tfact_factory_id}"
                           data-id="${row.tfact_factory_id}"
                          
                           ${isChecked}  data-table="t_factory_master"   >
                </div>
            `;
                    }
                },
    ...
    useEffect(() => {
        if (exportsLists.length > 0) {
            tableToExcel("new-table", "Factory Master List"); // Trigger export once data is set
        }
    }, [exportsLists]);
            ...
            <div className="home-content">
                <div className="card pb-3">
                    ...
                    <div className="card-body at-elevation-z6 table-box" style={{ maxHeight: "calc(100vh - 23vh);", overflowX: 'auto' }}>
                        ...
                        <div className="initiated-Factory-table-container">
                            <div className="mt-2 table table-bordered">
                                <div>
                                    {(permissions.indexOf('list') > -1) ?
                                        <table id="initiated-Factory-datatable" className="table table-bordered dataTable">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>State</th>
                ...
                <div className="allModals">
                    ...
                    >
                        <Modal.Header closeButton>
                            <Modal.Title>{editFactory == '' ? 'Add Factory' : 'Update Factory'}</Modal.Title>
                        </Modal.Header>
                        ...
                        <Modal.Body>
                            <AddEditFactory
                                ...
                                initiatedFactoryDatatable={initiatedFactoryDatatable}
...
export default FactoryMasterList;
