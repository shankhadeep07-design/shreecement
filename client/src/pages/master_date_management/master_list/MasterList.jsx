...
// import { getExcelExportMasterList } from '../../../Services/Master-service.js';
...
const MasterList = () => {
    ...
    let datatable_url = `${import.meta.env.VITE_API_URL}/admin/masters-management/master-list/datatable`;
    ...
    const subMasterListFun = (data) => {
        setEditMasterList(data);
        window.open(
            `${import.meta.env.VITE_HOME_PAGE}/admin/sub_master_list/${data.tml_id}`,
            "_blank"
        );
    };
    ...
    const initiatedMasterListDatatable = () => {
        ...
        var my_url = `${import.meta.env.VITE_API_URL}/admin/masters-management/master-list/datatable`;
        ...
        $("#initiated-MasterList-datatable").DataTable({
            ...
            columns: [
                ...
                },
                {
                    ...
                    data: "tml_master_list_name",
                    searchable: true,
                    orderable: true,
                },
                {
                    name: "tml_master_list_desc",
                    data: "tml_master_list_desc",
                    searchable: true,
                    orderable: true,
                },
                  {
                ...
                <div class="form-check form-switch d-inline-block"
                    ...
                    <input class="form-check-input toggle-switch"
                           type="checkbox"
                           id="toggleSwitch_${row.tml_id}"
                           data-id="${row.tml_id}"
                          
                           ${isChecked}  data-table="t_master_list"   >
                </div>
            `;
                    }
                },
                                    ...
                                    <ul className="dropdown-menu">
                                        ...
                                        <li>
                                            <button
                                                ...
                                                onClick={() => subMasterListFun(record)}
                                            >
                                                <span style={{ marginRight: "5px" }}>
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                </span>
    ...
    useEffect(() => {
        if (exportsLists.length > 0) {
            tableToExcel("new-table", "Master List"); // Trigger export once data is set
        }
    }, [exportsLists]);
                        ...
                        <div className="float-right">
                            {
                                ...
                                <button
                                    ...
                                    onClick={() => addFun()}
                                >
                                    <i class="fa-solid fa-plus"></i> Add Master List
                ...
                <div className="allModals">
                    ...
                    >
                        <Modal.Header closeButton>
                            <Modal.Title>{editMasterList == '' ? 'Add Master List' : 'Update Master List'}</Modal.Title>
                        </Modal.Header>

                        <Modal.Body>
                            <AddEditMasterList
                                changeModalStatus={changeModalStatus}
                                editMasterList={editMasterList}
                                initiatedMasterListDatatable={initiatedMasterListDatatable}
