...
import { getAllLocationApi } from "../../services/Location-service";
...
export default function ProposalAddUpdateModal({ details, showModal, changeModalStatus, initListDatatable, my_url }) {
    ...
    const inputChange = (e, meta) => {
        if (meta && meta.name) {
            ...
            // Example: trigger district fetch if state
        ...
        // handle native inputs (text/select)
        ...
        if (type === "text" || type === "textarea") {
            newValue = value.replace(/^\s+/, "");  // removes all leading spaces
        }
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <div className="row">
                                    ...
                                    {/* <div className="col-md-4">
                                    <div className="mb-3">
                                        <label htmlFor="tpros_location" className="form-label">
                                            Location
                                        </label>
                                        <select
                                            className="form-control"
                                        ...
                                        {errors?.tpros_location && (
                                            <div className="error text-danger">{errors.tpros_location}</div>
                                        )}
                                    </div>
                                </div> */}
                            ...
                            <div className="card-body">
                                <div className="row">
                                    ...
                                    <div className="col-md-2">
                                        <div className="mb-3">
                                            <label htmlFor="tpros_particular" className="form-label">Particular</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                                name="tpros_particular"
                                                id="tpros_particular"
                                                value={formData.tpros_particular || ""}
                                                onChange={inputChange}
                                                placeholder="Enter particular"
                                            />
                                            {errors?.tpros_particular && <div className="error text-danger">{errors.tpros_particular}</div>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-2">
                                        <div className="mb-3">
                                            <label htmlFor="tpros_unit" className="form-label">Unit</label>
                                            <input
                                                type="text"
                                                className="form-control"
                                                name="tpros_unit"
                                                id="tpros_unit"
                                                value={formData.tpros_unit || ""}
                                                onChange={inputChange}
                                                placeholder="Enter unit"
                                            />
                                            {errors?.tpros_unit && <div className="error text-danger">{errors.tpros_unit}</div>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-2">
                                        <div className="mb-3">
                                            <label htmlFor="tpros_no_of_units" className="form-label">No of Units</label>
                                            <input
                                                type="number"
                                                className="form-control"
                                                name="tpros_no_of_units"
                                                id="tpros_no_of_units"
                                                min="0"
                                                value={formData.tpros_no_of_units || ""}
                                                onChange={inputChange}
                                                placeholder="Enter number of units"
                                            />
                                            {errors?.tpros_no_of_units && <div className="error text-danger">{errors.tpros_no_of_units}</div>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-2">
                                        <div className="mb-3">
                                            <label htmlFor="tpros_unit_cost" className="form-label">Unit Cost</label>
                                            <input
                                                type="number"
                                                className="form-control"
                                                name="tpros_unit_cost"
                                                id="tpros_unit_cost"
                                                min="1"
                                                value={formData.tpros_unit_cost || ""}
                                                onChange={inputChange}
                                                placeholder="Enter unit cost"
                                            />
                                            {errors?.tpros_unit_cost && <div className="error text-danger">{errors.tpros_unit_cost}</div>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-2">
                                        <div className="mb-3">
                                            <label htmlFor="tpros_total_amount" className="form-label">Total</label>
                                            <input
                                                type="number"
                                                className="form-control"
                                                name="tpros_total_amount"
                                                id="tpros_total_amount"
                                                min="1"
                                                value={formData.tpros_total_amount || ""}
                                                onChange={inputChange}
                                                placeholder="Enter total amount"
                                            />
                                            {errors?.tpros_total_amount && <div className="error text-danger">{errors.tpros_total_amount}</div>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-2">
                                        <div className="mb-3">
                                            <label htmlFor="tpros_gst_amount" className="form-label">GST</label>
                                            <input
                                                type="number"
                                                className="form-control"
                                                name="tpros_gst_amount"
                                                id="tpros_gst_amount"
                                                min="1"
                                                value={formData.tpros_gst_amount || ""}
                                                onChange={inputChange}
                                                placeholder="Enter GST amount"
                                            />
                                            {errors?.tpros_gst_amount && <div className="error text-danger">{errors.tpros_gst_amount}</div>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-2">
                                        <div className="mb-3">
                                            <label htmlFor="tpros_total_incl_gst" className="form-label">Total incl GST</label>
                                            <input
                                                type="number"
                                                className="form-control"
                                                name="tpros_total_incl_gst"
                                                id="tpros_total_incl_gst"
                                                min="1"
                                                value={formData.tpros_total_incl_gst || ""}
                                                onChange={inputChange}
                                                placeholder="Enter total including GST"
                                            />
                                            {errors?.tpros_total_incl_gst && <div className="error text-danger">{errors.tpros_total_incl_gst}</div>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-md-4">
                                        <div className="mb-3">
                                            <label
                                                htmlFor="tpros_attachment_documents"
                                            ...
                                            >
                                                <Upload
                                                    ...
                                                    onChange={({ fileList }) => {
                                                        ...
                                                        handleChange("tpros_attachment_documents", fileList);
                                                    }}
                                                        ...
                                                        >
                                                            ...
                                                            <Popconfirm
                                                                ...
                                                                onConfirm={() => {
                                                                    ...
                                                                    setFileLists((prev) => ({
                                                                        ...prev,
                                                                        tpros_attachment_documents: updatedList,
                                                                    }));
