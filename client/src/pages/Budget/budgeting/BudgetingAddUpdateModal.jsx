...
import {
  ...
  fetchVillagesByRevenueVillageIds,
} from "../../../services/Master-service";
  ...
  const handleChange = useCallback((name, value) => {
    ...
    setFormData((prev) => {
      ...
      if (name === "tbm_state_id") {
        ...
        updated.tbm_block_id = [];
        updated.tbm_gram_panchayat_id = [];
        updated.tbm_revenue_village_id = [];
        updated.tbm_village_id = [];
      ...
      if (name === "tbm_revenue_village_id") {
        ...
        if (value && value.length > 0) {
          fetchVillagesByRevenueVillageIds(value, prev.tbm_unit_id).then(
            (res) => {
            const villageData = res?.data || [];
            setVillages(villageData);
            // Auto-select all villages according to selected revenue villages
            setFormData((p) => ({
              ...p,
              tbm_village_id: villageData.map((v) => v.value),
            }));
          });
        } else {
          updated.tbm_village_id = [];
  ...
  useEffect(() => {
    if (editData) {
      ...
      setFormData({
        ...
        tbm_block_id: editData.tbm_block_id
          ? String(editData.tbm_block_id).split(",").filter(Boolean)
          : [],
        tbm_gram_panchayat_id: editData.tbm_gram_panchayat_id
          ? String(editData.tbm_gram_panchayat_id).split(",").filter(Boolean)
          : [],
        tbm_revenue_village_id: editData.tbm_revenue_village_id
          ? String(editData.tbm_revenue_village_id).split(",").filter(Boolean)
          : [],
        tbm_village_id: editData.tbm_village_id
          ? String(editData.tbm_village_id).split(",").filter(Boolean)
          : [],
        ...
        try {
          ...
          setFormData((prev) => ({
            ...
            tbm_gram_panchayat_id: editData.tbm_gram_panchayat_id
              ...
              : [],
            tbm_revenue_village_id: editData.tbm_revenue_village_id
              ? String(editData.tbm_revenue_village_id)
                  .split(",")
                  .filter(Boolean)
              : [],
            tbm_village_id: editData.tbm_village_id
            ...
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                ...
                <Select
                  isMulti
                  options={blocks}
                  value={blocks.filter((o) =>
                    formData.tbm_block_id?.includes(String(o.value)),
                  )}
              ...
              <div className="col-md-6 mb-3">
                ...
                <Select
                  ...
                  value={gramPanchayats.filter((o) =>
                    formData.tbm_gram_panchayat_id?.includes(String(o.value)),
                  )}
                  onChange={(selectedOptions) =>
                    handleChange(
                      "tbm_gram_panchayat_id",
              ...
              <div className="col-md-6 mb-3">
                ...
                <Select
                  ...
                  value={revenueVillages.filter((o) =>
                    formData.tbm_revenue_village_id?.includes(String(o.value)),
                  )}
                  onChange={(selectedOptions) =>
                    handleChange(
                      "tbm_revenue_village_id",
              ...
              <div className="col-md-6 mb-3">
                ...
                <Select
                  isMulti
                  options={villages}
                  value={villages.filter((o) =>
                    formData.tbm_village_id?.includes(String(o.value)),
                  )}
                  onChange={(selectedOptions) =>
                    handleChange(
                      "tbm_village_id",
              ...
              <div key={index} className="border p-3 mb-3">
                <div className="row">
                  <div className="col-md-4">
                    <label>Thematic Area(Schedule VII Item No)</label>
