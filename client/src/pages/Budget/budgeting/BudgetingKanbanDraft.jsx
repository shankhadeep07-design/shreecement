...
const BudgetingKanbanDraft = ({ permissions = [], refreshSendForApproval }) => {
      ...
      <div className="kanban-header header-col-1">
          ...
          <div>
            ...
            <Tooltip title="Add Budget">
              <Button
                type="primary" className="add-btn ml-2"
                icon={<PlusOutlined />}
                size="small"
                onClick={addFun}
              />
                ...
                <Card size="small" className="budget-card" style={{ borderBottom: "solid 4px #e9bc55ff" }} >
                  ...
                  <div className="card-top-row">
                    ...
                    <div className="card-info">
                      ...
                      <span className="card-text-bold">
                        {budget.tbm_proposed_total_amount}
                      </span>
                    </div>
                  </div>
...
export default BudgetingKanbanDraft;
