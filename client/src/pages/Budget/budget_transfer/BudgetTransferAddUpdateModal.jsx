  ...
  tbm_budget_list: Yup.array()
    .of(
      Yup.object({
        ...
        tbad_description: Yup.string().required("Brief Description is required"),
...
export default function BudgetTransferAddUpdateModal({
  showModal,
  changeModalStatus,
  editData,
  fetchBudgets,
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>{editData ? "Update Budgeting" : "Add Budgeting"}</Modal.Title>
      </Modal.Header>
      ...
      <Modal.Body>
        ...
        <div className="overflow-y-auto"  style={{ height: "80vh" }}>
          <div className="row">
                                ...
                                <div className="card transfer-details-card">
                                    <div className="card-header header-bg">
                                         <h5 className="f-small mb-0 text-white">Transfer Details</h5>
                                    </div>
                                    <div className="card-body">
                                        <div className="overflow-auto"  style={{ height: "65vh" }}>
                                            <div className="row">
                                        <div className="col-md-12" id="AnnualPlanBudgetDistributionBox">
                            ...
                            /> */}
                                                ...
                                                {/*<div class="border rounded p-2 mt-3">
                                                    <div class="row my-2">                          
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <textarea name="tapbd_remarks" id="tapbd_remarks" class="form-control" rows="2"></textarea>
                                                ...
                                                */}
                                                ...
                                                <div className="row my-4 text-right">
                                                    ...
                                                    <button className="btn btn-info btn-md text-white" type="submit"> Transfer Amount</button>
