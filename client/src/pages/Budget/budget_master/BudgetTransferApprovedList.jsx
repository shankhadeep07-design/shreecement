...
export default function BudgetTransferApprovedList() {
  ...
  const navigate = useNavigate();
      ...
      return $("#list_table2").DataTable({
        ...
        ajax: {
          ...
          dataSrc: function (json) {
            json.data = json.data.filter(row => row.tbtm_status === "approved"); // Keep only approved rows
            return json.data;
          }
        },
        paging: true,
              ...
              ReactDOM.createRoot(td).render(
                <>
                  <div
                    ...
                    onClick={() => handleViewBudgetTransferApproved(rowdata)}
                  >
                    {`${
    ...
    const handleViewBudgetTransferApproved = (rowdata) => {
  ...
  return (
    ...
    <div className="table-responsive">
                      <table className="table table-bordered dataTable" id="list_table2">
                        <thead>
                          <tr>
