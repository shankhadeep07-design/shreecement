...
export const vendorCreateApi = (data) => {
    return privateAxios.post('admin/vendor/create', data).then((response)=> response.data);
}
export const fetchVendorDetailsApi=(id)=>{
    return privateAxios.post(`admin/vendor/details/${id}`).then((response)=>response.data)
}
...
export const fetchVendorDetailsFunApi = (data) => {
    return privateAxios.post('admin/vendor/vendor_details', data).then((response)=> response.data);
}
